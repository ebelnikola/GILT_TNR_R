...
vals, vecs = eigsolve(TM_crossed_4, randn(30, 30, 30, 30, 30), 120, :LM; krylovdim=120);

serialize("rot_alg_TM_crossed_after_newton_r=4_120_states.data", (vals, vecs))
...
open("rot_alg_TM_crossed_after_newton_r=4_120_states.log",
    "w") do io
